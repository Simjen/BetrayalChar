...
public class Player {
	...
	public int getKnowlage(){
		...
		return knowlageStat.getStatValue();
	}
	...
	public void pickUpItem(Items i){
		...
		knowlageStat.Increase(i.knowlage);
	...
	public void dropItem(Items i){
		...
		knowlageStat.Decrease(i.knowlage);
		if (i.useable){
	...
	public Player(int player){
		if(player == 1){
			...
			knowlageStat = new Stat(Stats.PLAYER1KNOWLAGE.start,Stats.PLAYER1KNOWLAGE.stat);
			...
			knowlageStat = new Stat(Stats.PLAYER2KNOWLAGE.start,Stats.PLAYER2KNOWLAGE.stat);
			...
			knowlageStat = new Stat(Stats.PLAYER3KNOWLAGE.start,Stats.PLAYER3KNOWLAGE.stat);
			...
			knowlageStat = new Stat(Stats.PLAYER4KNOWLAGE.start,Stats.PLAYER4KNOWLAGE.stat);
			...
			knowlageStat = new Stat(Stats.PLAYER5KNOWLAGE.start,Stats.PLAYER5KNOWLAGE.stat);
			...
			knowlageStat = new Stat(Stats.PLAYER6KNOWLAGE.start,Stats.PLAYER6KNOWLAGE.stat);
			...
			knowlageStat = new Stat(Stats.PLAYER7KNOWLAGE.start,Stats.PLAYER7KNOWLAGE.stat);
			...
			knowlageStat = new Stat(Stats.PLAYER8KNOWLAGE.start,Stats.PLAYER8KNOWLAGE.stat);
			...
			knowlageStat = new Stat(Stats.PLAYER9KNOWLAGE.start,Stats.PLAYER9KNOWLAGE.stat);
			...
			knowlageStat = new Stat(Stats.PLAYER10KNOWLAGE.start,Stats.PLAYER10KNOWLAGE.stat);
			...
			knowlageStat = new Stat(Stats.PLAYER11KNOWLAGE.start,Stats.PLAYER11KNOWLAGE.stat);
			...
			knowlageStat = new Stat(Stats.PLAYER12KNOWLAGE.start,Stats.PLAYER12KNOWLAGE.stat);
